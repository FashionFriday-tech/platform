 ...
 * Account Status
 */
export const AccountStatusEnum = z.enum(['ACTIVE', 'SUSPENDED', 'BANNED', 'PENDING_VERIFICATION']);
...
export const WalletTransactionStatusEnum = z.enum(['PENDING', 'COMPLETED', 'FAILED']);
export type WalletTransactionStatus = z.infer<typeof WalletTransactionStatusEnum>;

/**
 * Referral
 */
export const ReferralRewardStatusEnum = z.enum(['PENDING', 'RELEASED', 'CANCELLED']);
