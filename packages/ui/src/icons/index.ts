...
import { PiArrowsLeftRightLight, PiMapPin, PiShoppingBag, PiBriefcaseFill } from 'react-icons/pi';
import {
  RiArrowUpDownLine,
  RiMenuSearchLine,
  RiShieldStarFill,
...
import { RxHamburgerMenu, RxStarFilled, RxStar } from 'react-icons/rx';
