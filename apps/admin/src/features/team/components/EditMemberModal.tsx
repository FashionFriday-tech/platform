...
import { ROLE_LABELS, ROLE_DESCRIPTIONS, TeamMember } from '../types';
      ...
      <div className="flex w-full max-w-lg flex-col overflow-hidden rounded-3xl bg-white shadow-2xl dark:bg-[#111111]">
        ...
        <div className="flex items-center justify-between border-b border-black/5 p-6 dark:border-white/5">
          <div>
            ...
            <p className="mt-1 text-sm text-black/60 dark:text-white/60">Manage role and access for {member.name}</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6 p-6">
          <div className="flex flex-col gap-3">
            <label className="text-sm font-semibold text-black dark:text-white">Account Status</label>
