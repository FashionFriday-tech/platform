  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 items-center gap-2 sm:gap-3 min-w-0">
        <div className="hidden md:flex items-center rounded-xl border border-black/5 bg-[#f8f9fa] p-1 dark:border-white/5 dark:bg-[#1a1a1a]">
          <button
            type="button"
        ...
        <div className="relative flex-1 min-w-0">
          ...
          <input
            type="text"
            className="block w-full rounded-xl border border-black/5 bg-[#f8f9fa] py-2 sm:py-2.5 pr-8 pl-9 sm:pl-10 text-xs sm:text-sm text-black placeholder-black/35 transition-all outline-none focus:border-black/20 focus:bg-white focus:ring-4 focus:ring-black/5 dark:border-white/5 dark:bg-[#1a1a1a] dark:text-white dark:placeholder-white/35 dark:focus:border-white/20 dark:focus:bg-[#222222] dark:focus:ring-white/5 truncate"
      ...
      <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
        ...
        <button
          type="button"
          className="flex items-center justify-center gap-1.5 rounded-xl bg-black px-3 sm:px-4 py-2 text-xs sm:text-sm font-semibold whitespace-nowrap text-white shadow-sm transition-all hover:bg-black/85 active:scale-95 dark:bg-white dark:text-black dark:hover:bg-white/90"
        >
