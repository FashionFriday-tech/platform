...
import { PackageIcon, ShoppingBagIcon, StoreIcon, UsersIcon } from '@ff/ui';
import { motion } from 'motion/react';

import { type SellerStatsData } from '../types';
      ...
      {statCards.map((card, i) => (
        ...
        >
          ...
          <div className="pointer-events-none absolute inset-0 overflow-hidden">
            <card.icon className="absolute -right-2 -bottom-2 h-16 w-16 text-white/[0.04] dark:text-black/[0.04]" />
          ...
          <div className="relative z-10 mt-2 flex items-baseline justify-between gap-2">
            ...
            <div className="flex items-center gap-1.5">
              <span className={`h-1.5 w-1.5 shrink-0 rounded-full ${card.dotColor}`} />
