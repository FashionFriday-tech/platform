        ...
        <div className="space-y-8 lg:col-span-7 lg:py-6">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex flex-wrap items-center gap-3 text-[10px] font-black tracking-widest text-black/60 uppercase dark:text-white/60">
              ...
              {product.quality && (
                <span className="flex items-center gap-1.5 rounded-full border border-blue-500/20 bg-blue-50 px-3 py-1.5 text-blue-600 shadow-sm transition-transform hover:-translate-y-0.5 dark:border-blue-500/30 dark:bg-blue-500/10 dark:text-blue-400">
              ...
              {/* Product Brand ID Badge */}
              <div
                className="flex items-center gap-1.5 rounded-full border border-black/10 bg-black/5 px-3 py-1.5 font-mono text-[11px] font-bold text-black/80 shadow-sm transition-transform hover:-translate-y-0.5 dark:border-white/10 dark:bg-white/10 dark:text-white/80"
          ...
          <div>
            <div className="mb-2 flex items-center gap-2 font-mono text-xs text-black/50 dark:text-white/50">
              ...
              <button
                ...
                className="cursor-pointer text-black/40 transition-colors hover:text-black dark:text-white/40 dark:hover:text-white"
                title="Copy Product ID"
              >
                <svg className="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
