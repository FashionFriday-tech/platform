  ...
  return (
    <div className="animate-in fade-in duration-300">
      <div className="flex gap-2">
        <div className="flex shrink-0 items-center justify-center rounded-full border-2 border-zinc-800 bg-zinc-900 px-4 text-sm font-bold text-zinc-400">
          +91
        </div>
        <input
          type="tel"
      ...
      <div className="mt-2 h-4 px-6">
        {errors.phone && (
          <p className="text-[10px] leading-none font-bold tracking-widest text-red-500 uppercase">
            {errors.phone}
          </p>
        )}
      </div>
