...
function getUtcMetric(interval = 5) {
    const now = Date.now(); // server time
    const seconds = Math.floor(now / 1000);
    return seconds - seconds % interval;
}
}),
"[project]/src/app/api/utc-metric/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const runtime = "nodejs"; // important
async function GET() {
    const value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$time$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUtcMetric"])(5);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__60e7e942._.js.map