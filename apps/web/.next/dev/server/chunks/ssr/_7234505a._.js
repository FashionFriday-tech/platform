...
function filterProducts(products, activeFilters) {
    return products.filter((product)=>{
        for (const [filterKey, selectedOptions] of Object.entries(activeFilters)){
            // Skip if no filters are selected for this category
            if (!selectedOptions || selectedOptions.length === 0) continue;
            // --- 1. Handle Price Range ---
            if (filterKey === 'priceRange') {
                const rangeString = selectedOptions[0]; // e.g., "0-5000"
            ...
            // --- 2. Handle Attribute Filters (Brand, Size, Color, etc.) ---
            const productValue = product[filterKey];
            // If product doesn't have the attribute (like 'size' for a watch), and filter is active, hide it
...
//# sourceMappingURL=_7234505a._.js.map