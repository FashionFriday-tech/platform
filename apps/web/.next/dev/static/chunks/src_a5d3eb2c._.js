...
"[project]/src/features/product-catalogue/hooks/use-catalogue.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useCatalogue(initialProducts) {
    ...
    const maxPriceLimit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_c57d9b56c0bd86dac4690a5de51b3a27$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useCatalogue.useMemo[maxPriceLimit]": ()=>{
            if (initialProducts.length === 0) return 30000;
            return Math.ceil(Math.max(...initialProducts.map({
                "useCatalogue.useMemo[maxPriceLimit]": (p)=>p.price
            }["useCatalogue.useMemo[maxPriceLimit]"])) / 1000) * 1000;
        }
    }["useCatalogue.useMemo[maxPriceLimit]"], [
        initialProducts
    ]);
    ...
    const filteredProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_c57d9b56c0bd86dac4690a5de51b3a27$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useCatalogue.useMemo[filteredProducts]": ()=>{
            let result = initialProducts.filter({
                "useCatalogue.useMemo[filteredProducts].result": (product)=>{
                    for (const [key, values] of Object.entries(activeFilters)){
                        ...
                        const matches = values.some({
                            "useCatalogue.useMemo[filteredProducts].result.matches": (v)=>v.toLowerCase() === productValue
                        }["useCatalogue.useMemo[filteredProducts].result.matches"]);
                        if (!matches) return false;
                    }
                    return true;
                }
            }["useCatalogue.useMemo[filteredProducts].result"]);
            // 4. Sorting Logic
            const strategies = {
                "price-asc": {
                    "useCatalogue.useMemo[filteredProducts]": (a, b)=>a.price - b.price
                }["useCatalogue.useMemo[filteredProducts]"],
                "price-desc": {
                    "useCatalogue.useMemo[filteredProducts]": (a, b)=>b.price - a.price
                }["useCatalogue.useMemo[filteredProducts]"],
                "most-sold": {
                    "useCatalogue.useMemo[filteredProducts]": (a, b)=>(b.salesCount || 0) - (a.salesCount || 0)
                }["useCatalogue.useMemo[filteredProducts]"],
                "newest": {
                    "useCatalogue.useMemo[filteredProducts]": (a, b)=>b.staticNumber - a.staticNumber
                }["useCatalogue.useMemo[filteredProducts]"]
            };
...
_s(useCatalogue, "eVIADXXoeDK35QzLCkgCJOtg60g=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/features/product-catalogue/hooks/use-auto-scroll.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var _s = __turbopack_context__.k.signature();
;
function useAutoScroll(speed = 3) {
    _s();
    ...
    const stopAutoScroll = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_c57d9b56c0bd86dac4690a5de51b3a27$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAutoScroll.useCallback[stopAutoScroll]": ()=>{
    ...
    const toggleAutoScroll = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_c57d9b56c0bd86dac4690a5de51b3a27$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAutoScroll.useCallback[toggleAutoScroll]": ()=>{
            if (isAutoScrolling) {
                stopAutoScroll();
            } else {
                setIsAutoScrolling(true);
                const step = {
                    "useAutoScroll.useCallback[toggleAutoScroll].step": ()=>{
                        window.scrollBy({
                            top: speed,
                            behavior: "auto"
                        });
    ...
    // Industrial Standard: Stop on user interaction
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_c57d9b56c0bd86dac4690a5de51b3a27$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAutoScroll.useEffect": ()=>{
            const handleManualInteraction = {
                "useAutoScroll.useEffect.handleManualInteraction": ()=>{
            ...
            window.addEventListener("mousedown", handleManualInteraction);
            return ({
                "useAutoScroll.useEffect": ()=>{
                    window.removeEventListener("wheel", handleManualInteraction);
                    window.removeEventListener("touchmove", handleManualInteraction);
                    window.removeEventListener("mousedown", handleManualInteraction);
...
_s(useAutoScroll, "/PG/nBuQdwY4dC5jco1EqikoFuA=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/features/product-catalogue/components/FilterSection.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/features/product-catalogue/index.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$product$2d$catalogue$2f$hooks$2f$use$2d$catalogue$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/product-catalogue/hooks/use-catalogue.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$product$2d$catalogue$2f$hooks$2f$use$2d$auto$2d$scroll$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/product-catalogue/hooks/use-auto-scroll.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$product$2d$catalogue$2f$components$2f$FilterSection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/product-catalogue/components/FilterSection.tsx [app-client] (ecmascript)");
;
;
;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
// Feature Imports
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$product$2d$catalogue$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/features/product-catalogue/index.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$product$2d$catalogue$2f$hooks$2f$use$2d$catalogue$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/product-catalogue/hooks/use-catalogue.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$product$2d$catalogue$2f$hooks$2f$use$2d$auto$2d$scroll$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/product-catalogue/hooks/use-auto-scroll.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$product$2d$catalogue$2f$components$2f$FilterSection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/product-catalogue/components/FilterSection.tsx [app-client] (ecmascript)");
// Shared/UI Imports
...
function BrandClient({ brandSlug }) {
    ...
    const baseProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_c57d9b56c0bd86dac4690a5de51b3a27$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BrandClient.useMemo[baseProducts]": ()=>{
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$store$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_PRODUCTS"].filter({
                "BrandClient.useMemo[baseProducts]": (p)=>p?.brand?.toLowerCase() === brandSlug.toLowerCase()
            }["BrandClient.useMemo[baseProducts]"]);
        }
    }["BrandClient.useMemo[baseProducts]"], [
        brandSlug
    ...
    // 2. Logic Hooks
    const { filteredProducts, activeFilters, setActiveFilters, sortBy, setSortBy, maxPriceLimit } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$product$2d$catalogue$2f$hooks$2f$use$2d$catalogue$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCatalogue"])(baseProducts);
    const { isAutoScrolling, toggleAutoScroll } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$product$2d$catalogue$2f$hooks$2f$use$2d$auto$2d$scroll$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAutoScroll"])(settings?.autoScrollLevel);
    // 3. Staged Mobile State
    const [stagedFilters, setStagedFilters] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_c57d9b56c0bd86dac4690a5de51b3a27$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(activeFilters);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_c57d9b56c0bd86dac4690a5de51b3a27$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const filterConfigs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$_c57d9b56c0bd86dac4690a5de51b3a27$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BrandClient.useMemo[filterConfigs]": ()=>[
                {
                    id: "priceRange",
                    label: "Budget",
                    options: []
                },
                {
                    ...
                    options: Array.from(new Set(baseProducts.map({
                        "BrandClient.useMemo[filterConfigs]": (p)=>p.category
                    }["BrandClient.useMemo[filterConfigs]"])))
                },
                {
                    id: "color",
                    label: "Colors",
                    options: Array.from(new Set(baseProducts.map({
                        "BrandClient.useMemo[filterConfigs]": (p)=>p.color
                    }["BrandClient.useMemo[filterConfigs]"]).filter(Boolean)))
                }
            ]
    }["BrandClient.useMemo[filterConfigs]"], [
        baseProducts
...
_s(BrandClient, "epplXaEJGy88lkgFOaSexQK22Ak=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$product$2d$catalogue$2f$hooks$2f$use$2d$catalogue$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCatalogue"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$product$2d$catalogue$2f$hooks$2f$use$2d$auto$2d$scroll$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAutoScroll"]
    ];
});
_c = BrandClient;
var _c;
...
//# sourceMappingURL=src_a5d3eb2c._.js.map