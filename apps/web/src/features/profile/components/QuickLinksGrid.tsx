        ...
        return (
          ...
          >
            ...
            <div className="flex-1 sm:flex-none">
              <h3 className="text-foreground text-lg uppercase tracking-tighter sm:text-xl sm:font-bold">
                {link.label}
              </h3>
              <p className="text-foreground mt-2 hidden text-xs font-medium uppercase leading-relaxed tracking-widest opacity-0 transition-opacity duration-500 group-hover:opacity-100 sm:block">
                {link.description}
              </p>
            </div>
