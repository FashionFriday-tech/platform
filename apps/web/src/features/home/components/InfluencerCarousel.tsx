...
export default function TrendingCoverflowPage() {
  ...
  return (
    <section className="w-full sm:py-24 bg overflow-hidden">
      ...
      <div className="relative w-full h-96 sm:h-125 flex items-center justify-center sm:my-10 ">
        <div 
      ...
      <div className="sm:mt-4 flex justify-center gap-10">
        <button
          onClick={handlePrev}
