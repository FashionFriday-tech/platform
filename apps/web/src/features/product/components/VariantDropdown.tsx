...
const SelectionTray = ({
  ...
  <div
    className={`border border-white/25 p-4 transition-all duration-300 rounded-4xl`}
  >
    <button
      onClick={onToggle}
      className="w-full flex justify-between items-center font-black uppercase text-white"
    >
