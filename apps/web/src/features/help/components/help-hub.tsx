    ...
    <div className="animate-in fade-in duration-1000">
      ...
      <section className="mb-10 grid h-auto grid-cols-1 gap-4 md:h-64 md:grid-cols-2 lg:grid-cols-3">
        <Link
          ...
          className="border-border group flex items-center justify-between rounded-4xl border p-12 transition-all duration-500 hover:bg-[#25D366]"
        >
        ...
        <Link
          ...
          className="border-border group flex items-center justify-between rounded-4xl border p-12 transition-all duration-500 hover:bg-[#2576d3]"
        >
          {' '}
          <div className="flex items-center gap-6">
            <div className="bg-background-muted rounded-full p-4 group-hover:bg-white/20">
        ...
        <button
          ...
          className="border-border group flex w-full items-center justify-between rounded-4xl border p-12 text-start transition-all duration-500 hover:bg-[#d32525]"
        >
          <div className="flex items-center gap-6">
            <div className="bg-background-muted rounded-full p-4 group-hover:bg-white/20">
      ...
      <section className="mb-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {helpSections.map((item, index) => (
          <Link
            key={item.id}
            href={item.href}
            className={`border-border hover:bg-foreground group relative flex aspect-3/2 flex-col justify-between rounded-4xl border-y p-12 transition-all duration-700 lg:border-x`}
          >
