  ...
  return (
    <div className="selection:bg-brand min-h-screen bg-[#050505] pb-32 font-sans uppercase text-[#f0f0f0] selection:text-black">
      ...
      <header className="mx-auto max-w-7xl border-b border-white/5 px-6 pb-20 pt-32">
        ...
        <h1 className="mb-8 text-7xl font-black italic leading-[0.8] tracking-tighter md:text-[9vw]">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 border-t border-white/5 pt-12 md:grid-cols-4">
            {[
              ...
              <div key={i}>
                ...
                <p className="text-xs font-bold lowercase italic leading-tight opacity-40">
                  {step.desc}
                </p>
              </div>
            ))}
          ...
          return (
            ...
            >
              <div className="flex h-full flex-col">
                ...
                <h3 className="mb-4 text-3xl font-black italic tracking-tighter">
                  {section.title}
                </h3>
                <p className="mb-10 max-w-xs text-xs font-bold leading-relaxed opacity-40">
                  {section.description}
                </p>
      ...
      <section className="mx-auto mt-6 grid max-w-7xl grid-cols-1 gap-6 px-6 lg:grid-cols-3">
        ...
        <div className="relative overflow-hidden rounded-[3rem] border border-white/10 bg-[#0f0f0f] p-12 lg:col-span-2">
          <GlobeIcon
            className="absolute -bottom-10 -right-10 rotate-12 opacity-[0.03]"
            size={300}
          />
          <div className="relative z-10 space-y-8">
            <div className="flex items-center gap-4">
              <AlertTriangleIcon className="text-brand" size={32} />
              <h3 className="text-4xl font-black italic tracking-tighter">Fraud & Abuse Control</h3>
            </div>
            <p className="max-w-xl text-xs font-bold leading-relaxed opacity-50">
        ...
        <div className="bg-brand flex flex-col justify-between rounded-[3rem] p-12 text-black">
          ...
          <div>
            <h3 className="mb-4 text-3xl font-black italic tracking-tighter">Advance COD Fee</h3>
            <p className="mb-6 text-[11px] font-black italic leading-relaxed">
      ...
      <section className="mx-auto mt-6 max-w-7xl px-6 text-center lg:text-left">
        <div className="flex flex-col items-center justify-between gap-6 rounded-[2.5rem] border border-white/5 bg-white/5 p-8 md:flex-row md:px-12 md:py-8">
          <div className="flex items-center gap-4">
            ...
            <p className="max-w-2xl text-[9px] font-bold uppercase tracking-widest opacity-40">
          ...
          <button className="hover:text-brand flex items-center gap-2 whitespace-nowrap text-[10px] font-black tracking-widest transition-colors">
      ...
      <footer className="mx-auto mt-32 flex max-w-7xl flex-col items-center border-t border-white/5 px-6 pt-20">
        <h2 className="mb-12 text-4xl font-black italic tracking-tighter">Billing Inquiries?</h2>
        ...
        <p className="mt-24 text-[9px] font-black italic tracking-[0.4em] opacity-20">
