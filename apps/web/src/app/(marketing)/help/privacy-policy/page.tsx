...
export default function PrivacyPolicyPage() {
  return (
    <div className="selection:bg-brand min-h-screen bg-[#050505] pb-32 font-sans text-[#f0f0f0] selection:text-black">
      {/* 1. PROTOCOL HEADER */}
      <header className="mx-auto max-w-7xl px-6 pb-16 pt-24 text-center md:text-left">
        <div className="bg-brand/10 border-brand/20 mx-auto mb-6 flex w-fit items-center gap-2 rounded-full border px-4 py-1.5 md:mx-0">
          ...
          <span className="text-brand text-[9px] font-black uppercase tracking-[0.5em]">
            Security Standard v4.0.26
          </span>
        </div>
        <h1 className="mb-8 text-6xl font-black uppercase italic leading-[0.8] tracking-tighter md:text-[8vw]">
          Privacy <br /> <span className="italic opacity-10">Protocol.</span>
        </h1>
        <p className="max-w-xl text-[11px] font-bold uppercase italic leading-relaxed tracking-widest opacity-40">
          ...
          >
            <div className="flex flex-col items-start gap-8 md:flex-row">
              ...
              <div className="space-y-4">
                ...
                <p className="text-[13px] font-medium uppercase leading-relaxed tracking-tight opacity-50">
                  {section.content}
                </p>
              </div>
            </div>
        ...
        <div className="mt-12 rounded-[3.5rem] border border-white/5 bg-white/5 p-10 md:p-20">
          <div className="grid grid-cols-1 gap-20 lg:grid-cols-2">
            <div className="space-y-8">
              ...
              <p className="text-xs font-bold uppercase leading-loose tracking-widest opacity-40">
            ...
            <div className="space-y-6">
              {[
                ...
                >
                  ...
                  <div>
                    <h4 className="mb-1 text-[11px] font-black uppercase tracking-widest">
                      {right.label}
                    </h4>
                    <p className="text-[10px] font-medium uppercase italic leading-tight opacity-40">
                      {right.desc}
                    </p>
                  </div>
                </div>
      ...
      <footer className="mx-auto mt-24 max-w-5xl px-6">
        <div className="bg-brand relative space-y-8 overflow-hidden rounded-[4rem] p-12 text-center text-black md:p-24">
          <div className="relative z-10">
            <h2 className="text-5xl font-black uppercase italic leading-[0.8] tracking-tighter md:text-7xl">
            ...
            <div className="mt-12 flex flex-col justify-center gap-4 md:flex-row">
              <button className="rounded-full bg-black px-10 py-5 text-[10px] font-black uppercase tracking-widest text-white transition-transform hover:scale-105">
