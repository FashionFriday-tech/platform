...
export default function MasterTermsPage() {
  return (
    <div className="selection:bg-brand min-h-screen bg-[#050505] pb-32 font-sans text-[#f0f0f0] selection:text-black">
      {/* 1. HEADER */}
      <header className="mx-auto max-w-7xl border-b border-white/5 px-6 pb-20 pt-24">
        ...
        <h1 className="mb-10 text-6xl font-black uppercase italic leading-[0.8] tracking-tighter md:text-[9vw]">
      ...
      <main className="mx-auto mt-16 grid max-w-7xl grid-cols-1 gap-6 px-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        {(termsData as TermSector[]).map((sector) => (
          ...
          >
            ...
            <h3 className="mb-4 text-xl font-black uppercase italic tracking-tighter">
              {sector.title}
            </h3>
            <p className="text-[11px] font-medium uppercase italic leading-relaxed opacity-50">
              {sector.content}
            </p>
          </div>
        ))}
      ...
      <section className="mx-auto mt-6 max-w-7xl px-6">
        <div className="grid grid-cols-1 gap-20 rounded-[4rem] border border-white/5 bg-white/5 p-10 md:p-20 lg:grid-cols-2">
          <div className="space-y-12">
            <div>
              <h4 className="text-brand mb-4 flex items-center gap-2 text-xs font-black uppercase tracking-widest">
      ...
      <footer className="mx-auto mt-24 max-w-7xl border-t border-white/5 px-6 pt-16 text-center">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="space-y-2">
            <h5 className="text-xs font-black uppercase tracking-widest">16. Contact Protocol</h5>
          ...
          <p className="mt-10 text-[8px] font-black uppercase tracking-[0.4em] opacity-20">
