  ...
  return (
    <div className="bg-background text-foreground min-h-screen px-4 py-10 transition-colors duration-500 md:px-8">
      <main className="mx-auto max-w-4xl space-y-4 md:pt-20">
        <section
          className="text-foreground relative space-y-6 overflow-hidden rounded-xl rounded-tr-[4rem] rounded-bl-[4rem] p-6 shadow-xl md:p-8"
          style={{
        ...
        >
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="flex flex-col items-start gap-6 md:flex-row md:items-center">
              ...
              <div className="flex-1">
                ...
                <p className="mt-2 max-w-xl text-xs text-white/70 md:text-sm">
                  Share your referral link. When your friend places and receives their first order,
                  ₹100 lands in your wallet.
                </p>
              </div>
            </div>
            ...
            <p className="text-center text-[10px] text-white/40">
              Reward credited after successful delivery of your friend’s first order.
            </p>
          </div>
        </section>
          ...
          {metrics.map((m, i) => (
            ...
            >
              <div className="flex items-center gap-4">
                <div className="bg-foreground/5 text-foreground-subtle rounded-xl p-2.5">
                  {m.icon}
                </div>
                <div>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between px-4 pt-4">
            <h3 className="text-foreground-subtle text-[9px] font-black tracking-[0.3em] uppercase">
              Activity
            </h3>
            ...
            <AnimatePresence mode="popLayout">
              {sortedUsers.map((user) => (
                <motion.div
                  ...
                  key={user.id}
                  className="bg-background border-border flex h-32 flex-col justify-between rounded-[1.5rem] border p-5 shadow-sm"
                >
