      ...
      <main className="mx-auto max-w-2xl space-y-10 px-4 pt-12">
        ...
        >
          ...
          <div className="flex-1">
            <h2 className="text-xl font-black uppercase italic leading-none tracking-tight">
              Ajmal Faris
            </h2>
            <p className="text-foreground-subtle mt-2 text-[10px] font-bold uppercase tracking-widest opacity-60">
        ...
        <div className="space-y-3">
          <p className="text-foreground-subtle px-6 text-[10px] font-black uppercase tracking-[0.3em] opacity-60">
            Interaction
          </p>
          <div className="bg-background border-border/40 divide-border/20 rounded-4xl divide-y overflow-hidden border shadow-sm">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4 text-left">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-foreground-subtle mt-1 text-[9px] font-bold uppercase tracking-widest">
        ...
        <div className="space-y-4 pt-4">
          <button className="bg-background border-border rounded-4xl group flex w-full items-center justify-between border p-4 transition-all active:scale-[0.98]">
            <div className="flex items-center gap-4 text-left">
              ...
              <span className="text-sm font-black uppercase italic tracking-tight">Log Out</span>
            </div>
          ...
          <button
            ...
            className="rounded-4xl flex w-full items-center justify-center gap-3 border border-red-500/20 bg-red-500/5 p-6 text-red-600 transition-all active:scale-[0.98]"
          >
            <TrashIcon size={18} />
        ...
        <div className="space-y-2 py-10 text-center opacity-30">
          <p className="text-[9px] font-black uppercase italic tracking-[0.5em]">
            Fashion Friday v1.0
          </p>
          <Link
        ...
        {showDeleteModal && (
          <>
            <motion.div
              ...
              className="bg-background/80 z-100 fixed inset-0 backdrop-blur-xl"
            />
            <motion.div
              initial={{ y: 100, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              exit={{ y: 100, opacity: 0 }}
              className="bg-background border-border z-110 fixed bottom-0 w-full max-w-xl rounded-t-[3.5rem] border-t p-10 shadow-2xl lg:bottom-1/2 lg:left-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 lg:rounded-[3rem] lg:border lg:p-12"
            >
              ...
              <div className="space-y-6">
                ...
                <p className="text-foreground-subtle text-[10px] font-bold uppercase leading-loose tracking-widest">
                ...
                <div className="space-y-3 pt-8">
                  <button className="w-full rounded-full bg-red-600 py-5 text-[10px] font-black uppercase tracking-widest text-white shadow-2xl shadow-red-600/30 transition-all active:scale-95">
                  ...
                  <button
                    ...
                    className="bg-foreground text-background w-full rounded-full py-5 text-[10px] font-black uppercase tracking-widest"
                  >
  ...
  return (
    <div className="hover:bg-foreground/5 group flex cursor-pointer items-center justify-between p-6 text-left transition-colors">
      <div className="flex items-center gap-4">
        ...
        <span className="text-sm font-black uppercase italic tracking-tight transition-transform group-hover:translate-x-1">
          {label}
        </span>
      </div>
